    ...
    <section className="relative overflow-hidden min-h-screen">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 py-32 md:py-40 flex flex-col items-center justify-center text-center">
        ...
        >
          ...
          <span style={{ color: '#a57c00' }}>Proud Of</span>
        </h1>
        ...
        <p
          ...
          style={{ color: '#0d3d3d' }}
        >
          Explore a collection of our Dream projects. Every space tells a story of thoughtful design and meticulous craftsmanship.
        </p>
