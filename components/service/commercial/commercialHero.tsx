...
export function CommercialHero() {
  return (
    <section className="relative overflow-hidden min-h-screen">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center bg-fixed opacity-10 bg-[#e8e4de] bg-[url('/background/background9.jpg')]"
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 py-32 md:py-40 flex flex-col items-center justify-center text-center min-h-screen">
        ...
        >
          ...
          <span className="text-[#a57c00]">Not Just Interiors</span>
        </motion.h1>
        ...
        >
          We create smart, scalable interior solutions for offices, retail, and commercial environments—balancing aesthetics, efficiency, and brand identity.
        </motion.p>
