    ...
    <section className="py-24 lg:py-32 bg-[#f9f7f4] relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light text-[#0d3d3d] mb-6 leading-tight">
            {"Let's Design the Interior"} <span className="text-[#a57c00]">Right</span>
          </h2>

          <p className="text-lg md:text-xl text-[#0d3d3d]/70 max-w-2xl mx-auto mb-10 leading-relaxed">
            {"If you're looking for architectural clarity and functional precision, let's begin."}
          </p>
        </motion.div>
